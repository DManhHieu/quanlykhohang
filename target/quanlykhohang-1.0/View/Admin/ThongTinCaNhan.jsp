                                ...
                                <form method="post" action="${pageContext.request.contextPath}/ThongTinCaNhan">
                                    <div class="row">
                                        <div class="col-md-12">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <button type="button" style="border-radius: 5px; border-color: #007bff; background-color: #007bff" class="float-right btn-success" onclick="DoiMatKhau()">Đổi mật khẩu</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="w-100">
                                                    <button type="submit" style="border-radius: 5px; border-color: #007bff; background-color: #007bff" class="float-right btn-success mt-3">Lưu</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
