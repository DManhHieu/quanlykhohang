    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid pb-4">
                <h1 class="mt-4">Nhân viên mới</h1>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <form method="post" action="${pageContext.request.contextPath}/QuanLyNhanVien/Moi">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="bmd-label-floating">Mã nhân viên</label> <input
                                                                    type="text" class="form-control"  name="MaNhanVien">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="bmd-label-floating">Tên nhân viên</label> <input
                                                                    type="text" class="form-control"  name="TenNhanVien" >
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="bmd-label-floating">Tên đăng nhập</label> <input
                                                                    type="text" class="form-control"   name="TenDangNhap">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="bmd-label-floating">Số CMND</label> <input
                                                                    type="text" class="form-control"  name="SoCMND">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="NhomNhanVien">
                                                                    <c:forEach items="${NhomNhanViens}" var="nhom">
                                                                        <option value="${nhom.getID()}">${nhom.getTenNhom()}</option>
                                                                    </c:forEach>
                                                                </select>
                                                            </div>
                                                        </div>
